...
var clean = require('gulp-clean');
 ...
 gulp.task('copyhtml', function (done) {//../js/**/*.js' **/*.html
...
gulp.task('connect:dist',function(cb){
 ...
 gulp.task('watchs',function(){//监听变化执行任务
    //当匹配任务变化才执行相应任务
    gulp.watch(['**/*.html','!dist/**/*.html'],gulp.series('copyhtml'));
    gulp.watch(['**/**.css','!dist/**/*.css'],gulp.series('style'));
    // gulp.watch('app/scss/**/*.scss',gulp.series('css'));
    gulp.watch(['**/**.js','!dist/**/*.js'],gulp.series('js'));
...
gulp.task('serve',gulp.series('connect:dist','build','clean:alldist','watchs'));